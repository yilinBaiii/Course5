...
tesla_revenue = tesla_revenue.drop(['Tesla Quarterly Revenue(Millions of US $).1', 'Tesla Quarterly Revenue(Millions of US $)'], axis=1)
...
gme_data = GameStop.history(perioid = "max")
...
gme_revenue = gme_revenue.drop(['GameStop Quarterly Revenue(Millions of US $)', 'GameStop Quarterly Revenue(Millions of US $).1'], axis = 1)
